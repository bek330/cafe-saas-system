...
function OrderLayout() {
  ...
  return (
    <div className="min-h-screen bg-coffee-900/70 flex flex-col selection:bg-coffee-400 selection:text-coffee-900">
      <Header />

      <div className="max-w-7xl mx-auto w-full flex flex-col gap-8 px-4 py-8 md:py-16 lg:flex-row items-start flex-1">
        <main className="flex-1 w-full bg-coffee-500 rounded-[3rem] shadow-2xl p-6 md:p-16 border border-white/5 backdrop-blur-sm relative overflow-hidden">
